...
<section class="w-full">
    ...
    <x-courses.layout :heading="'Buchung - '.$booking->id"   :subheading="__('Deine Kurse')">
            ...
            <flux:heading size="lg">Gebuchte Termine</flux:heading>
            ...
            @foreach($booking->bookingSlots as $bookingSlot)
                <tr>
                <td class="px-4 py-2">{{ $bookingSlot->id }}</td>
            ...
            @foreach($booking->refunds as $refund)
                <tr>
                <td class="px-4 py-2">{{ $refund->id }}</td>
